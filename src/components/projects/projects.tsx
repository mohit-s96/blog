...
const projects = [
  ...
  {
    pName: "tiny react",
    uri: "https://github.com/msx47/tiny_react",
    about:
  ...
  },
  {
    ...
    uri: "https://github.com/msx47/youtube_ocr_extension",
    about:
  ...
  },
  {
    ...
    uri: "https://github.com/msx47/terminal-reddit",
    about:
  ...
  return (
    ...
    >
      <div className="m-2 p-2 text-primary-accent-dark text-xl md:text-2xl flex justify-between">
        ...
        <a
          href="https://github.com/msx47?tab=repositories"
